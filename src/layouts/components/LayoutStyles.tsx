...
export interface LayoutStylesProps {
  ...
  startMenuTheme: any;
  startMenuBaseRadius: number | string;
  startMenuPanelRadius: number | string;
  isEnglishLocale: boolean;
}

/** 布局相关两段内联 CSS（从 BasicLayout 原样拆出，保持行为不变） */
export const LayoutStyles: React.FC<LayoutStylesProps> = ({
  token,
  isDarkMode,
  isLightModeLightBg,
